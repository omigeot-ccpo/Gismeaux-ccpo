...
<?php if ($vpg=='pgsql') {
	...
	if ($nvl=='O'){
		...
		rename_table("cadastre.b_exodgi",$ann_ref,$ctab);
		rename_table("cadastre.b_habdgi",$ann_ref,$ctab);
		rename_table("cadastre.b_prodgi",$ann_ref,$ctab);
		rename_table("cadastre.b_subdgi",$ann_ref,$ctab);
		rename_table("cadastre.b_taxdgi",$ann_ref,$ctab);
		rename_table("cadastre.batidgi",$ann_ref,$ctab);
		rename_table("cadastre.p_exoner",$ann_ref,$ctab);
		rename_table("cadastre.p_subdif",$ann_ref,$ctab);
		rename_table("cadastre.p_taxat",$ann_ref,$ctab);
		rename_table("cadastre.parcel",$ann_ref,$ctab);
		rename_table("cadastre.propriet",$ann_ref,$ctab);
