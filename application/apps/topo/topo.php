...
if ($_GET['obj_keys']){
   ...
   $r1=$DB->tab_result($q1);
   $dess="../../doc_commune/".$insee."/dwf/".strtolower($r1[0]['local1'])."/".strtolower($r1[0]['fichier']);
   $dess1=$insee."/doc_commune/dwf/".strtolower($r1[0]['local1'])."/".strtolower($r1[0]['fichier']);
}
