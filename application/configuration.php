...
echo "<SCRIPT LANGUAGE=\"JavaScript\">
	...
	$projection_query="select * from public.spatial_ref_sys where auth_srid between 27500 and 27595";
	$mn1=$DB->tab_result($projection_query);
	for ($z=0;$z<count($mn1);$z++)
{
echo "<OPTION value=\"".$mn1[$z]['srid']."\">".substr($mn1[$z]['srtext'],21,strpos($mn1[$z]['srtext'], '",')-21)."</OPTION>";
}
	echo "</SELECT>\n";
	echo "<br>\n";
	echo "</td></tr>\n";	
