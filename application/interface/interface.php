...
for ($c=0;$c<count($cou);$c++)
  {
    ...
    if($cou[$c]['vu_initial']==1) // FIXME: Test assez vilain, à arranger.
      {
	$extraction.="extract('".$leg."','".$cous."','','".$typ."');";
      }
    else
      {
	if ($_SESSION["sel_layers"])
	  if (in_array($c,$_SESSION["sel_layers"]))
	    $extraction.="extract('".$leg."','".$cous."','','".$typ."');";
      }
    $legende.="<g id=\"com".$z."\">\n";
...
$data.="<svg id=\"svg2\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink='http://www.w3.org/1999/xlink' width=\"100%\" heigth=\"100%\" viewBox=\"0 0 800 600\" onkeypress=\"tape(evt);tapenum(evt)\" onload=\"init(evt);".$extraction."\" onmousemove=\"determ_ratio()\">";
...
<glyph unicode=\"a\" glyph-name=\"a\" horiz-adv-x=\"2048\" d=\"M217 675q-61.2598 0 -60 -120q1.27051 -120.981 60 -120q60 0.857422 60 120q0 120 -60 120zM97 556q0 151.009 120 150q118.234 -0.985352 120 -150q1.77734 -150 -120 -150q-120 -0.750977 -120 150zM2032 508l-19 -94h-241v14q22 1 30 9t8 30v186q0 28 -7 36.5
t-29 8.5v9h237v-84h-8q-5 40 -26.5 56.5t-67.5 16.5q-18 0 -24.5 -5t-6.5 -25v-93h6q26 0 39.5 15q13.5107 15 20.5 51h10v-145h-10q-4 36 -17.5 50.5t-42.5 14.5h-6v-98q0 -16 5.5 -21.5t23.5 -5.5h12q37 0 62.5 19t37.5 55h13zM1230 1544q-21 -2 -27.5 -8.5t-6.5 -30.5
v-248h-12l-185 230v-174q0 -23 8 -30.5t29 -8.5v-10h-92l1 10q22 2 29 9t7 30v198l-14 17q-2 1 -5 5q-8 9 -17 11l-1 10h86l148 -182v133q0 22 -7.5 29.5t-31.5 9.5v10h92zM1743 553l-518 -137l-140 -518l-139 518l-518 137l518 137l139 520l140 -520zM1122 -295
q34 -17 48 -37.5t14 -52.5q0 -42 -27 -66t-74 -24q-19 0 -42 7t-25 7q-6 0 -9.5 -3t-5.5 -11h-10v104h12q10 -46 29.5 -68t52.5 -22q25 0 38.5 13t13.5 36q0 15 -7.5 25.5t-25.5 19.5l-39 21q-39 20 -54.5 40.5t-15.5 49.5q0 38 23.5 61t60.5 23q15 0 62 -12q6 -1 9 -2
q5 1 8 4.5t5 9.5h13v-92h-10q-14 38 -34.5 58t-46.5 20q-20 0 -31.5 -10.5t-11.5 -28.5t7.5 -27.5t31.5 -21.5zM1206 678l-119 432v-547zM1659 553h-565l116 -121zM1077 559l-116 115l-429 -115h545zM1083 -4v553l-118 -121z\" />
...
if (1 || $_SESSION["user"]->has_right("impression"))
  {
    $data.="<g id=\"impression\">
...
if(1 || $_SESSION["user"]->has_right("regle")) // TODO: Intégrer une vérification de profil ici.
  {
...
if (1 || $_SESSION["user"]->has_right("polygo"))
  {
    if($cou[0]['btn_polygo']!="")
      {
...
if (1 || $_SESSION["user"]->has_right("enregistre"))
  {
