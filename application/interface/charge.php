...
if ( $_GET["type"]=='raster')
  {
 ...
 else
   {
	 ...
	 if($cou[0]['schema']!="bd_topo")
	   {
		 ...
		 $f.=" where (code_insee like '".substr($insee,0,3)."%' or code_insee is null) and ".$geometrie." && box'($xm,$ym,$xma,$yma)'";
	       }
	     else
	       {
	 ...
	 if($cou[0]['schema']!="bd_topo")
	   {
		 ...
		 $f.=" where (code_insee like '".substr($insee,0,3)."%' or code_insee is null) ";
	       }
	     else
	       {
		 
		 $f.=" where (code_insee = '".$insee."' or code_insee is null) ";
	       }
	   }
	 else
	   {
     ...
     if($cou[0]['stroke_rgb']!=''&&$cou[0]['stroke_rgb']!='none')
       {
	 $styl.="stroke:rgb(".$cou[0]['stroke_rgb'].");";
       }
     else
       {
	 $styl.="stroke:none;";
     ...
     if($cou[0]['stroke_width']!='')
       {
	 $styl.="stroke-width:".$cou[0]['stroke_width'].";";
       }
     else
       {
	 $styl.="stroke-width:1;";
     ...
     if($cou[0]['pointer_events']=='visible')
       {
	 $textq.="pointer-events=\"visible\" ";
       }
     else
       {
	 $textq.="pointer-events=\"none\" ";
       }
