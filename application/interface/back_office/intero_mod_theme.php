...
gis_session_start();
$requete="select libelle_them,schema,tabl,raster,partiel,vu_initial,zoommin,zoommax,zoommax_raster,groupe,force_chargement from admin_svg.theme where idtheme=".$_GET["idtheme"];
