create table cadastre.batiment06 as select * from cadastre.batiment;
...
create table cadastre.lieudit06 as select * from cadastre.lieudit;
...
create table cadastre.numvoie06 as select * from cadastre.numvoie;
...
create table cadastre.parcelle06 as select * from cadastre.parcelle;
...
create table cadastre.nomvoie06 as select * from cadastre.nomvoie;
